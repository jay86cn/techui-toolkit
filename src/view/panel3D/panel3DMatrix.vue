...
<template>
  <adaptivePanel :config="adptivePanelConfig">
    ...
    <div class="title-desc">Matrix mode, all panels have the same deformation effect, all parameters are common, through v-for loop</div>
    <div class="panel3D-test-matrix-wrap">
...
.adaptivePanel {
  .title-desc{.poa; top:20px; left:50%; .fixc("x"); font-size: 18px; .fc(@bk);}
}
</style>